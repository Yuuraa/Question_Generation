...
def squad_convert_example_to_features(example, max_seq_length, doc_stride, max_query_length, is_training):
    ...
    while len(spans) * doc_stride < len(all_doc_tokens):
        ...
        # padding 까지 동시에 할 수 있음! max_length 를 input 으로 넣어주면 된다
...
# From transformers github squad.py
...
# SquadV1Processor(SquadProcessor), SquadV2Processor 삭제..
# train_file 과 dev_file 만 설정해주면 되었음
